...
export class MessageManagerService {
  ...
  private messages: Array<string> = [
    ...
    'Second is the "Spothiefy"',
    'It is a copy of Spothiefy music player',
    'I have to say that I am not proud of it',
    'From the perspective of time I see a lot of mistakes in this project',
    ...
    'You can check them by clicking GitHub icon in bottom-left corner or in previously mentioned info section!',
